...
if __name__ == "__main__":
    ...
    for i in range(100,200):
        net = torch.load(os.path.join(base_dir, f"checkpoint/cifar10_4x_{i}.pth"), weights_only=False)
        # print(net)
        ...
        with open("./results/results.txt", "a") as f:
            f.write(f"idx: {i}, acc: {acc}, Best acc: {best_acc} at {best_idx}\n")
        print(f"acc: {acc}, Best acc: {best_acc} at {best_idx}")
